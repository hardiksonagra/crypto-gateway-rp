 ...
 *   address on repeat calls; reuse open `created` checkout when reference/amount match; else new placeholder.
 *   Pool rows are only used when still unassigned (`assigned_user_id` null).
