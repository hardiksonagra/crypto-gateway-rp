...
/**
 * Background poller: sequential chain scans to bound RPC concurrency.
 * Horizontal scaling: run multiple workers with per-chain leader election (Redis/DB advisory lock) — not shown here.
 */
...
export function stopBlockchainWorker(): void {
