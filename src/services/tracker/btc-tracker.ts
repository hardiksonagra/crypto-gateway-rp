...
/**
 * Bitcoin deposits via Esplora-style HTTP (default: mempool.space public API).
 * Sum vout values to our P2PKH address per tx; confirmations from chain tip height.
 */
export async function scanBtcChain(): Promise<void> {
