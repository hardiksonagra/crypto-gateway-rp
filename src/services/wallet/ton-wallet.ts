...
/**
 * TON BIP44: m/44'/607'/0'/0/{index} (all hardened segments per @ton/crypto deriveEd25519Path).
 * Non-bounceable user-friendly form (UQ...) — typical for deposits.
 */
export async function deriveTonAddress(accountIndex: number, mnemonic: string): Promise<string> {
