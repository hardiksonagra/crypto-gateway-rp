...
/**
 * TRON uses SLIP44 coin type 195 (m/44'/195'/0'/0/i).
 * We only expose the derived address — private keys never leave signing services.
 */
export function deriveTronAddress(accountIndex: number, mnemonic: string): string {
