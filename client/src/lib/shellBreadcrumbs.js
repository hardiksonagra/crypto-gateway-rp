...
export function buildAdminBreadcrumbs(pathname, extras) {
  ...
  const tailMap = {
    ...
    "pay-ins": { label: "Transactions", to: "/control/pay-ins" },
    "pay-outs": { label: "Payout", to: "/control/pay-outs" },
    transactions: { label: "Transactions", to: "/control/pay-ins" },
    settlements: { label: "Transactions settlements", to: "/control/pay-in-settlements" },
    "pay-in-settlements": { label: "Transactions settlements", to: "/control/pay-in-settlements" },
    "pay-out-settlements": { label: "Payout settlements", to: "/control/pay-out-settlements" },
...
export function buildRpBreadcrumbs(pathname, extras) {
  ...
  const tailMap = {
    ...
    "pay-ins": { label: "Transactions", to: "/rp/pay-ins" },
    "pay-outs": { label: "Payout", to: "/rp/pay-outs" },
...
export function buildMerchantBreadcrumbs(pathname) {
  ...
  const map = {
    ...
    "pay-in-settlements": "Transactions settlements",
    "pay-out-settlements": "Payout settlements",
    withdrawals: "Payout",
