      ...
      >
        ...
        <div className="relative">
          ...
          <div className="mt-8 flex flex-wrap gap-2">
            {["Multi-chain", "Multi-merchant", "Role-based access", "Live & sandbox"].map((f) => (
              <span
                key={f}
        ...
        <div className="relative mt-10 flex flex-wrap gap-6 pt-8 text-xs lg:mt-0"
          ...
          {[["Scope","Multi-chain · multi-merchant"],["Access","Role-based sessions"]].map(([label, val]) => (
            <div key={label}>
        ...
        >
          <div className="mb-8">
            ...
            <p className="mt-1.5 text-sm" style={{ color: "var(--text-2)" }}>
              Use your admin or merchant credentials.
            </p>
          </div>
