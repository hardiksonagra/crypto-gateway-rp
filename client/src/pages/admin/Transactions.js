              ...
              {!res.isLoading &&
                rows.map((t) => (
                  <tr key={t.id} className="text-white/85">
                    <td className="px-3 py-2 text-xs text-white/50">{t.created_at.slice(0, 19)}</td>
                    ...
                    <td className="max-w-[120px] truncate px-3 py-2 text-xs">{t.merchant.email}</td>
                    <td className="max-w-[100px] truncate px-3 py-2 font-mono text-xs">{t.external_user_id}</td>
                    <td className="max-w-[140px] truncate px-3 py-2 font-mono text-[10px] text-cyan-300/90">
                      {t.tx_hash}
                    </td>
                  </tr>
                ))}
